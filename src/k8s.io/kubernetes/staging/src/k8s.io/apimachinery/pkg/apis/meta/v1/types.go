...
type ObjectMeta struct {
	...
	// UID is the unique in time and space value for this object. It is typically generated by // 对象的唯一ID，在创建对象时生成，永不可改
	...
	// Must be empty before the object is deleted from the registry. Each entry  // 在资源被删除以前该列表必须为空。
	// is an identifier for the responsible component that will remove the entry // 列表中元素表示资源清理的模块，这些模块在清理完资源后会来删除该元素
	// from the list. If the deletionTimestamp of the object is non-nil, entries // 如果deletionTimestamp非空，则该列表中元素所指定的资源只能被删除
